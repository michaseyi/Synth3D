...
namespace ecs_hpp::detail
{
   ...
   public:
      ...
      {
         return dense_.capacity() * sizeof(dense_[0]) + sparse_.capacity() * sizeof(sparse_[0]);
      }
...
namespace ecs_hpp::detail
{
   ...
   public:
      ...
      std::size_t memory_usage() const noexcept
      {
         return keys_.memory_usage() + values_.capacity() * sizeof(values_[0]);
      }
...
namespace ecs_hpp
{
   ...
   class system<E, Es...>
       : public system<E>, public system<Es...>
   {
   };
}
...
namespace ecs_hpp
{
   ...
   {
      return (&l.owner() < &r.owner()) || (&l.owner() == &r.owner() && l.id() < r.id());
   }

   inline bool operator==(const entity &l, const entity &r) noexcept
   {
      return &l.owner() == &r.owner() && l.id() == r.id();
   }
